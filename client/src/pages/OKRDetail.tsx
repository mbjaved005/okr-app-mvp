...
export function OKRDetail() {
  ...
  const canEdit = okr && (
    okr.createdBy === loggedInUser.id ||
    okr.owners.includes(loggedInUser.id)
  );
            ...
            <CardContent className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-base">{format(new Date(okr.startDate), 'MMM dd, yyyy')}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">End Date</h3>
                  <p className="mt-1 text-base">{format(new Date(okr.endDate), 'MMM dd, yyyy')}</p>
                </div>
                <div>
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-3">Owners</h3>
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-4">Key Results</h3>
                <div className="space-y-4">
                    ...
                    <Card key={index} className="bg-gray-50 dark:bg-gray-800/50">
                      <CardContent className="p-4 space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Progress
                            value={Math.round((kr.currentValue / kr.targetValue) * 100)}
                            className="h-2"
                          />
                        </div>
                      </CardContent>
