...
export const register = async (data: { name: string; email: string; password: string; role: string; department: string; designation: string; profilePicture?: File }) => {
...
export const updateProfile = async (data: { name: string; email: string; department: string; designation: string; role: string }) => {
